    ...
    string strshort() const
        {
            ...
            for (auto i: *triangles)
                face_string += to_string(i) + " ";
            return "funnel(" + p.shortstr() + ' ' + q.shortstr() + "): x = " + x->shortstr()
                    + "; spq = " + to_string(spq_angle) + ", psq = " + to_string(psq_angle) + "; sequence: [" + face_string + "]; removed: " + to_string(removed);
        }
    string str() const;
